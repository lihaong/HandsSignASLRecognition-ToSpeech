...
from model import KeyPointClassifier2
from model import PointHistoryClassifier2
...
def main_gesture():
    ...
    keypoint_classifier = KeyPointClassifier2()
    point_history_classifier = PointHistoryClassifier2()
    ...
    with open(
            'model/point_history_classifier/point_history_classifier_label2.csv',
            encoding='utf-8-sig') as f:
